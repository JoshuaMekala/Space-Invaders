...
class Missile:
    ...
    #deletes the missile from the canvas
    def deactivate(self):
        self.canvas.delete(self.missile)
        self.__active = False
    #checks whether the missile is active or not
    def is_active(self):
        return self.__active
    # Moves the missile up by pixel increments 
    def next(self):
        if self.__active:
